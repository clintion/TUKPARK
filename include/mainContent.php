...
<title>TuPark Car Parking</title>
<style>
.wow {
    visibility: hidden;
}
...
padding-top:10px;
      ...
      <h5 class="h5 pt-2">
                <strong>REVERSE ENGINEERING BLOCK</strong>
     </h5>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center mb-1">
        ...
        <div class="text-center mt-4">
          <button class="btn  mt-1" style="background-color: #782F40 !important;">DONE <i class="fa fa-sign-in ml-1"></i></button>
        </div>
      </div>
