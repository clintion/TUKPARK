...
<title>TuPark car parking N-BLOCK area Parking</title>
<style>
.wow {
    visibility: hidden;
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center mb-1">
        ...
        <div class="text-center mt-4">
          <button class="btn  mt-1" type="submit" name="submit" style="background-color: #782F40 !important;">DONE <i class="fa fa-sign-in ml-1"></i></button>
        </form>
        </div>
      </div>
...
<!--Modal: Login with Avatar Form-->
    ...
    <div class="container">
      ...
      <h5 class="h5 pt-2">
                <strong id="areaname">N BLOCK PARK</strong>
     </h5>

   <div class="row py-2 px-2 pt-1">
     <div class="col-4 bs center font-weight-bold" id="27">
       SLOT 1
     </div>
     ...
     <div class="col-4 col-sm-4 bs center font-weight-bold" style="background-color:#FFDE59 !important;border:none !important;">
     
     </div>

      <div class="col-4 bs center font-weight-bold" id="28">
       SLOT 2
     </div>
     <div class="col-4 bs center font-weight-bold" style="background-color:black !important;border:none !important;">
     ...
     <div class="col-4 col-sm-4 bs center font-weight-bold" id="29">
      SLOT 4
     </div>

     <div class="col-4 col-sm-4 bs center font-weight-bold" id="30">
      SLOT 3
     </div>
     ...
     <div class="col-4 col-sm-4 bs center font-weight-bold" id="31">
      SLOT 5
     </div>
   </div>
</div>
...
$(".bs").click(function (){
    ...
    if(bg === "rgb(0, 0, 0)"){
        ...
        alert("BLACK MEANS THIS IS A PATH");
    }else{
